import { Button, Collapse, Divider, useDisclosure, Box, useColorModeValue } from "@chakra-ui/react"
...
function CollapseEx() {
    ...
    return (
      <>
        <Button rightIcon={<ChevronRightIcon />} colorScheme="teal" onClick={onToggle}> {isOpen ? 'Less' : 'More'}</Button>
        <Collapse in={isOpen} animateOpacity>
          ...
          >
                    ...
                    <ProgrammesList>
                        Computer Science, Mathematics, Information Technology, English, French.
                    </ProgrammesList>
          </Box>
        </Collapse>
      </>
