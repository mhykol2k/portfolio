      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section>
          <ProjectGridItem id="1" title="EPOS / Bar App" thumbnail={project1}>
            Electronic Point of Sale Application built using Flutter, built for
            client in Frinton-on-Sea.
          </ProjectGridItem>
        </Section>
        <Section>
          <ProjectGridItem
            id="2"
            title="Linux CLI Portfolio"
            thumbnail={project2}
          >
            'Linux Style' Command Line Interface Portfolio. Built with
            TypeScript and tested with Cypress.
          </ProjectGridItem>
        </Section>
